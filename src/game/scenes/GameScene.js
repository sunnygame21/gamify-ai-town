...
import { createInteractiveGameObject } from '@/game/utils';
import {
    NPC_MOVEMENT_RANDOM,
    SCENE_FADE_TIME,
} from '@/game/constants';
import { addHistory, getPrevAnser, getChatHistory, addChatHistory } from '@/game/ChatUtils';
import ModelDialog from '@/game/components/ModelDialog';
...
export default class GameScene extends Scene {
    ...
    genPrevConversation(characterName) {
        var currentMessage = "<span style='color:yellow'>you:" + getPrevAnser(characterName) + "</span><br>" + characterName + ":" + "";
